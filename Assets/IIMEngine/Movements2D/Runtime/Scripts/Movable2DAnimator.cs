...
namespace IIMEngine.Movements2D
{
    public class Movable2DAnimator : MonoBehaviour
    {
        ...
        private IMove2DSpeedReader _iMove2DSpeedReaderReference;
        ...
        private void Awake()
        {
            ...
            _iMove2DSpeedReaderReference = _movableGameObject.GetComponent<IMove2DSpeedReader>();
            _iMove2DLockedReaderReference = _movableGameObject.GetComponent<IMove2DLockedReader>();
        ...
        private void Update()
        {
            ...
            _animator.SetBool(_isMovingParameterHash, 
                !_iMove2DLockedReaderReference.AreMovementsLocked && _iMove2DSpeedReaderReference.MoveSpeed > 0f);
        }
    }
}